...
function fakeApi(): AgenticApi {
  return {
    ...
    loadApproval: vi.fn(async () => detail()), decideApproval: vi.fn(async () => ({ ...detail().approval, state: "revision_requested" as const, version: 2 })), listEmployees: vi.fn(), loadEmployee: vi.fn(), listAudit: vi.fn(), listCommandActivity: vi.fn(), recordCommandActivity: vi.fn(),
  };
}
