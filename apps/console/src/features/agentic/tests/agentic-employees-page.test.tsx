...
function fakeApi(): AgenticApi {
  ...
  return {
    ...
    listEmployees: vi.fn(async () => kinds.map((kind) => ({ kind, department: department(kind), active: true }))), listAudit: vi.fn(), listCommandActivity: vi.fn(), recordCommandActivity: vi.fn(),
