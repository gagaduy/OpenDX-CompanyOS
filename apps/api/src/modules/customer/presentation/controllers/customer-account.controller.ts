...
export class CustomerAccountController {
    ...
    try {
      res.json(
        successResponse(
          ...
          await this.service.get(customerState(res).customerId),
        ),
      );
    } catch (e) {
      next(e);
      ...
      res.json(
        successResponse(
          ...
          await this.service.update(
            ...
            parseBody(profileSchema, req.body),
          ),
        ),
      );
    } catch (e) {
  ...
  listAddresses: RequestHandler = async (_req, res, next) => {
    try {
      res.json(
        successResponse(
          "Addresses retrieved",
          await this.service.listAddresses(customerState(res).customerId),
        ),
      );
    } catch (e) {
      next(e);
        ...
        .json(
          successResponse(
            ...
            await this.service.createAddress(
              customerState(res).customerId,
              parseBody(addressCreateSchema, req.body),
            ),
          ),
        );
    } catch (e) {
      ...
      res.json(
        successResponse(
          ...
          await this.service.updateAddress(
            customerState(res).customerId,
            parseBody(idSchema, req.params.addressId),
            parseBody(addressUpdateSchema, req.body),
          ),
        ),
      );
    } catch (e) {
  ...
  deleteAddress: RequestHandler = async (req, res, next) => {
    try {
      await this.service.deleteAddress(
        customerState(res).customerId,
        parseBody(idSchema, req.params.addressId),
      );
      res.json(successResponse("Address deleted", {}));
    } catch (e) {
      next(e);
    }
  };
  defaultAddress: RequestHandler = async (req, res, next) => {
    try {
      await this.service.setDefaultAddress(
        customerState(res).customerId,
        parseBody(idSchema, req.params.addressId),
      );
