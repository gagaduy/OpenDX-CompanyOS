...
suite("Support migration", () => {
  ...
  it("creates constrained Support tables, rolls them back, and reapplies them", async () => {
    ...
    expect(indexes).toEqual(expect.arrayContaining(["support_tickets_queue_idx", "support_tickets_sla_claim_idx", "support_tickets_health_window_idx", "support_ticket_events_ticket_occurred_at_idx", "support_attachments_scan_claim_idx", "support_attachments_retention_claim_idx", "support_attachments_object_key_key", "support_ticket_events_ticket_idempotency_key_key"]));
