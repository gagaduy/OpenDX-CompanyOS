...
export const mapTicket=(t:SupportTicket)=>({id:t.id,customerId:t.customerId,...(t.customerEmail===undefined?{}:{customerEmail:t.customerEmail}),...(t.orderId===undefined?{}:{orderId:t.orderId}),subject:t.subject,description:t.description,priority:t.priority,status:t.status,version:t.version,createdById:t.createdById,...(t.assigneeId===undefined?{}:{assigneeId:t.assigneeId}),createdAt:t.createdAt,updatedAt:t.updatedAt});
