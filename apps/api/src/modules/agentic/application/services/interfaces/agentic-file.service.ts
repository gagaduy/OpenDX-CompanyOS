...
export interface AgenticFileUploadRequest { readonly originalFilename: string; readonly mediaType: "text/csv" | "text/plain"; readonly content: Buffer; }
export interface AgenticFilePreviewDto { readonly fileId: string; readonly previewVersion: number; readonly parserVersion: string; readonly payloadDigest: string; readonly previewDigest: string; readonly format: "csv" | "txt"; readonly rowCount: number; readonly columnCount: number; readonly samples: readonly string[]; readonly sourceReferences: readonly { readonly fileId: string; readonly line: number; readonly column?: number }[]; }
