...
test("requires private bounded file lifecycle and all rejection cases", () => {
  assert.doesNotThrow(() => validateAgenticPhaseE({ api: "private staff APIs /:fileId/approve", service: "FILE_CONTENT_INVALID FILE_SCAN_FAILED", storage: "agentic-intake/", parser: "maxRows", routes: "upload.single(\"file\")" }));
