...
export function productionFixtureEnvironment(base = process.env) {
  return {
    ...
    FACEBOOK_PAGE_ACCESS_TOKEN: "test-only-facebook-page-token",
    ...
    AGENT_MARKETING_CONTENT_CLIENT_SECRET: "test-only-agent-marketing-content",
    AGENT_MARKETING_VISUAL_CLIENT_SECRET: "test-only-agent-marketing-visual",
    AGENT_MARKETING_PUBLISHER_CLIENT_SECRET: "test-only-agent-marketing-publisher",
